...
export class AppComponent {
      ...
      features: [
        {
          ...
          geometry: {
            ...
            coordinates: [
              [
                [117.10976645350456, 40.19750502960819],
                [117.1108102798462, 40.19654006809559],
                [117.1096819639206, 40.19667938398167],
                [117.10968732833862, 40.19667528645969],
                [117.1108102798462, 40.19654143393899],
                [117.11105525493622, 40.19655782405776],
                [117.11116075515746, 40.196833723795784],
                [117.11113929748534, 40.19731722854997],
                [117.10983324050905, 40.19750789783849],
                [117.10976645350456, 40.19750502960819],
                [117.1108102798462, 40.19654006809559],
                [117.1096819639206, 40.196671188937465],
                [117.10952639579773, 40.196507287845485],
                [117.10956394672394, 40.19628738659143],
                [117.11034715175629, 40.196284654894356],
                [117.1108102798462, 40.19654006809559]
              ]
            ]
          }
  ...
  contrast(arr, features, e) {
    ...
    if (nearByArr1Point.length && nearByArr2Point.length) {
      ...
      // console.log(newArr1, "////获得合并后的图形坐标");
  ...
  refetchArray(obj, obj2) {
    ...
    let arr2 = obj2.arr;
    let newArr = [];
    let polygon1 = this.filterPolygon(obj);
    let polygon2 = this.filterPolygon(obj2);
    console.log(polygon1, "////polygontest1", polygon2);
    ...
    newArr = polygon1.arrFront
      ...
      .concat(polygon1.arrThree)
      .concat(polygon2.arrThree);
